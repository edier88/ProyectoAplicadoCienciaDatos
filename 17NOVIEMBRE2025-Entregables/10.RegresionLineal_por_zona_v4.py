...
GRAF_DIR = "RegresionLineal_Graficas_TrainTest_Renumerados"
os.makedirs(GRAF_DIR, exist_ok=True)

MODELOS_DIR = Path("RegresionLineal_Modelos_Guardados_Renumerados")
os.makedirs(MODELOS_DIR, exist_ok=True)

ORIGEN = "csv-zonas-wifi-separados-man-renumerados/"

DESTINO_METRICAS = Path("RegresionLineal_Metricas_Renumerados")

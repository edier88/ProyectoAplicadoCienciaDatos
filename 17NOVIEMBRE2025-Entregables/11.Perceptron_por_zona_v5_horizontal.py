...
GRAF_DIR = "Perceptron_Graficas_TrainTest_Renumerados"
os.makedirs(GRAF_DIR, exist_ok=True)

MODELOS_DIR = Path("Perceptron_Modelos_Guardados_Renumerados")
os.makedirs(MODELOS_DIR, exist_ok=True)

ORIGEN = "csv-zonas-wifi-separados-man-renumerados/"
#DESTINO_METRICAS = "Random_Forest_Metricas"
DESTINO_METRICAS = Path("Perceptron_Metricas_Renumerados")
...
for archivo in archivos:
    ...
    # ---------------------------------------------------------------------
    # Predicción modelo MLP base (sin hiperparámetros)
    # ---------------------------------------------------------------------
    ...
    forecaster.fit(
        y=df_train['USAGE_KB'],
        exog=df_train[todas_variables_entrada]  # Add exogenous variables here
    )

...
for archivo in archivos:
    ...
    def crear_exog_futura(ultima_fecha, df_historico, steps):
        """
        Busca el mismo período del año anterior (los días que se pongan en la variable steps).
    ...
    def crear_lags_exogenos(df_futuro, df_pasado, lags, steps):
        """Crea lags para las variables de entrada del modelo (variables exogenas"""
    ...
    modelo_completo = joblib.load(open(MODELOS_DIR / f"MLP_{nombre_zona_recortado}_v4.joblib", 'rb'))

...
GRAF_DIR = "Random_Forest_Graficas_TrainTest_Renumerados"
os.makedirs(GRAF_DIR, exist_ok=True)

MODELOS_DIR = Path("Random_Forest_Modelos_Guardados_Renumerados")
os.makedirs(MODELOS_DIR, exist_ok=True)

ORIGEN = "csv-zonas-wifi-separados-man-renumerados/"
#DESTINO_METRICAS = "Random_Forest_Metricas"
DESTINO_METRICAS = Path("Random_Forest_Metricas_Renumerados")

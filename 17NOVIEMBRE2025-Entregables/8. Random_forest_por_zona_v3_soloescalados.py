...
for archivo in archivos:
    ...
    forecaster.fit(
        ...
        exog=df_train[exog_variables_scaled]  # Variables de entrada para alimentar el modelo
    )
    ...
    df_errors.to_csv(DESTINO_METRICAS / "metricas_comparacion1.csv", index=False, encoding='utf-8')
